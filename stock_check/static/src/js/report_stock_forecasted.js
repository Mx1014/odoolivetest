odoo.define('stock_check.ReplenishReport', function (require) {
"use strict";
...
//        console.log(this.controlPanelProps)
...
//        };
    ...
    _renderWarehouseFilters: function () {
        return this._rpc({
            model: 'report.stock_check.report_product_product_replenishment',
