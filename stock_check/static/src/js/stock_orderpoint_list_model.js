odoo.define('stock_check.StockOrderpointListModel', function (require) {
"use strict";
...
var StockOrderpointListModel = ListModel.extend({
    ...
    replenish: function (records) {
      ...
      return this._rpc({
          ...
          return self.do_action('stock_check.action_replenishment');
      });
    },
    ...
    snooze: function (records) {
      var recordResIds = _.pluck(records, 'res_id');
      var self = this;
      return this.do_action('stock_check.action_orderpoint_snooze', {
          additional_context: {
              default_orderpoint_ids: recordResIds
          },
          on_close: () => self.do_action('stock_check.action_replenishment')
      });
    },
});
