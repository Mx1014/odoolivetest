odoo.define('stock_check.popover_widget', function (require) {
'use strict';
...
var PopoverWidgetField = AbstractField.extend({
    ...
    buttonTemplape: 'stock_check.popoverButton',
    popoverTemplate: 'stock_check.popoverContent',
    trigger: 'focus',
    placement: 'top',
    html: true,
    color: 'text-primary',
...
//        return this.do_action(action);
        ...
        var reportname = 'stock_check.report_product_product_replenishment?docids=' +
                          this.recordData.product_id.data.id +
