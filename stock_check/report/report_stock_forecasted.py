...
class ReplenishmentReport(models.AbstractModel):
    _name = 'report.stock_check.report_product_product_replenishment'
...
class ReplenishmentTemplateReport(models.AbstractModel):
    _name = 'report.stock_check.report_product_template_replenishment'
    _description = "Stock Replenishment Report"
    _inherit = 'report.stock_check.report_product_product_replenishment'
