odoo.define('pabs_logistics_extra.StockOrderpointListController', function (require) {
"use strict";
...
//        $buttonOrder.on('click', this.replenish.bind(this));
    ...
    this._super.apply(this, arguments);
      ...
      this.$buttons.on('click', '.o_button_order', this._onReplenish.bind(this));
