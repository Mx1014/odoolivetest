odoo.define('pabs_logistics_extra.popover_widget', function (require) {
'use strict';
...
var PopoverWidgetField = AbstractField.extend({
    ...
    buttonTemplape: 'pabs_logistics_extra.popoverButton',
    popoverTemplate: 'pabs_logistics_extra.popoverContent',
    trigger: 'focus',
    placement: 'top',
    html: true,
    color: 'text-primary',
     ...
     */
    async _openForecast(ev) {console.log(this.data);
        ev.stopPropagation();
        const reportContext = {
